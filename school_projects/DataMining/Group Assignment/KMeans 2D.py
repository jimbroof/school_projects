...
properties_to_cluster = ['Total_Publisher_Games', 'Average_Publisher_Sales_Log']
...
trace = go.Scatter(
    ...
    y = dataset['Average_Publisher_Sales_Log'],
...
predY = np.choose(kmeans.labels_, [0, 4, 3, 1, 5, 2, 6]).astype(np.int64)
trace = go.Scatter(
    x = dataset[properties_to_show[0]],
